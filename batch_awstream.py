...
# ]
fmts = [
    f'/dataheart/dataset/downtown/downtown_{i}/part%d.mp4' for i in range(2, 10)
]
...
for idx, fmt in enumerate(fmts):
    ...
    for bw_weight in [0.2, 0.05, 0.0125]:
        ...
        for downsample_factor in [3,4]:
            ...
            approach = f'awstream_{downsample_factor}x_bwweight_{bw_weight}'
