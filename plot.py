...
# query_approach(ax, "backprop_sigmoid_feature_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq5_num10', 16, '1280:720')
# # query_approach(ax, "backprop_sigmoid_feature_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq5_num10', 0, '1280:720')
# query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq5_num10', 16, '1280:720')

# query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq5_num10', 10, '1280:720')
# query_approach(ax, "backprop_sigmoid_feature_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq5_num10', 10, '1280:720')

print("low quality qp = 0")
query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq10_num10_new_prev', 0, '1280:720')

query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq5_num10', 0, '1280:720')
query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'test', 0, '1280:720')
# query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'test', 16, '1280:720')
query_approach(ax, "backprop_sigmoid_saliency_error_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq10_num10_saliency', 16, '1280:720')
...
query_approach(ax, "backprop_sigmoid_no_sr_1080_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq3_num5', 30, '1280:720')
query_approach(ax, "backprop_sigmoid_no_sr_1080_debug", 'ours ', 'f1', 'orange', 'yuhan_test_feb25_freq3_num5', 27, '1280:720')
